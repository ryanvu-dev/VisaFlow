...
**Core problem:**  
There is no simple, intuitive workflow for applicants to follow, nor a structured system for the coordinator to collect and manage required information and documents.
...
### Applicants
> When applying for a visa, applicants want a simple, step-by-step guide that clearly explains what to provide, so the process can be completed without confusion.

### Coordinator
> When assisting applicants, the coordinator wants a streamlined way to collect information and documents, so the application can be prepared efficiently without repeated explanations.
...
The application should feel like a guided checklist or folder — not a dashboard.

Every interaction should be obvious, visible, and linear.
